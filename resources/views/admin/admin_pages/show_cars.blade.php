            ...
            <div class="content-wrapper">
                ...
                <table class = 'center'>
                    ...
                    <tr>
                        ...
                        <td class = 'td_pad'><a class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this {{ $car->model }}')" href="{{ url('delete_car', $car-> id) }}">Delete</a></td>
                        <td class = 'td_pad'><a class="btn btn-success" href="{{ url('update_car', $car-> id)}}" >Edit</a></td>
                    </tr>
                    @endforeach
